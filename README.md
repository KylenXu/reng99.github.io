...
Hello，见者好:blush:!我是嘉明(***~~哈哈@～@，套近乎。~~***全名庞嘉明)，是一个`web前端开发工程师`。本站是自己搭建的博客，至此，自己的博客从[新浪博客](http://blog.sina.com.cn/reng99)-->[博客园](http://www.cnblogs.com/reng/)-->[github](https://github.com/reng99)-->[Reng の 博客](https://reng99.github.io/)。
...
哈哈哈 😄 ,啰里啰嗦润色了一下，***~~貌似跟之前的简历没啥区别的样子，难道变的是气质(幻想中ing)~~***如果看者觉得愚某还ok，请别吝啬你的橄榄枝哦--邮箱1837895991@qq.com(请别打电话，有可能编码的小灵感～)🙏 。

另外，如果看者想交个朋友的话，可以加个`微信`bei`加的时候请备注下您的姓名和地区`，谢谢啦！
